...
import { ReduxNetworkProvider, mapStateToProps } from '../src/components/ReduxNetworkProvider';
...
describe('ReduxNetworkProvider', () => {
  ...
  describe('handleConnectivityChange', () => {
    ...
    did not change`, () => {
      const wrapper = shallow(<ReduxNetworkProvider {...getProps({ isConnected: true })} />);
