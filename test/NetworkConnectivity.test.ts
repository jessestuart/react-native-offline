...
import { NetworkConnectivity, RequiredProps } from '../src/components/NetworkConnectivity';
...
const mockGetConnectionChangeHandler = jest.fn(() => mockConnectionChangeHandler);
...
jest.mock('../src/utils/checkInternetAccess', () => jest.fn().mockResolvedValue(true));
...
const getElement = ({ props = initialProps, Component = NetworkConnectivity }: GetElementParams = {}) => {
...
describe('NetworkConnectivity', () => {
  ...
  describe('componentDidMount', () => {
    describe('iOS, pingInterval = 0', () => {
      ...
      AND does NOT call setupConnectivityCheckInterval`, () => {
        ...
        expect(mockAddEventListener).toHaveBeenCalledWith('connectionChange', mockConnectionChangeHandler);
  ...
  describe('componentWillUnmount', () => {
    it(`removes the NetInfo listener with the right parameters
      ...
      expect(mockRemoveEventListener).toHaveBeenCalledWith('connectionChange', mockConnectionChangeHandler);
